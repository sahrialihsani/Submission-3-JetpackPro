...
object DummyData {
    fun generateMovData(): List<MovEntity> {
        val listMovie = ArrayList<MovEntity>()
        ...
        listMovie.add(
            MovEntity(
                ...
                backdrop = "https://image.tmdb.org/t/p/original/xcaSYLBhmDzJ6P14bcKe0KTh3QV.jpg",
                isFavorite = false
            )
        )
    ...
    fun generateTvData(): List<TvEntity> {
